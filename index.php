...
<?php
    ...
    include_once 'inclusions/carousel_premium.php';
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="advertise">
                <a href="#"><img src="http://placehold.it/960x90" alt="ad"> </a>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12 content content1">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 adp">
                            <div class="ads">
                                <a href="#"><img src="http://placehold.it/291x250" alt="ads"></a>
                        ...
                        <div class="col-md-3 col-sm-6 adp">
                            <div class="ads">
                                <a href="#"><img src="http://placehold.it/291x250" alt="ads"></a>
                                <div class="ads-title"><p><a href="#">Sun Glasses</a></p></div>
                                <a href="#" class="ads-hover">
                                    <span>$7,000</span>
                                    <i class="fa fa-bars fa-2x"></i>
                                </a>
                        ...
                        <div class="col-md-3 col-sm-6 adp">
                            <div class="ads">
                                <a href="#"><img src="http://placehold.it/291x250" alt="ads"></a>
                                <div class="ads-title"><p><a href="#">Iphone 10 month warranteed</a></p></div>
                                <a href="#" class="ads-hover">
                                    <span>$1,200</span>
                        ...
                        <div class="col-md-3 col-sm-6 adp">
                            <div class="ads">
                                <a href="#"><img src="http://placehold.it/291x250" alt="ads"></a>
                                <div class="ads-title"><p><a href="#">Dogie for sale urgent</a></p></div>
                                <a href="#" class="ads-hover">
                                    <span>$2,000</span>
